indexData = [
  ...
  ["__Enum method (Array)","lib/ArrayObj.htm#__Enum",7],
  ["__Enum method (Gui)","lib/GuiObj.htm#__Enum",7],
  ["__Enum method (Map)","lib/MapObj.htm#__Enum",7],
  ["__Init method","Objects.htm#Custom_Classes_var"],
  ["__Item property","Objects.htm#__Item"],
  ["__Item property (Array)","lib/ArrayObj.htm#__Item",7],
  ["__Item property (Gui)","lib/GuiObj.htm#__Item",7],
  ["__Item property (Map)","lib/MapObj.htm#__Item",7],
  ["__New meta-function","Objects.htm#Custom_NewDelete"],
  ["__New method (Array)","lib/ArrayObj.htm#__New",7],
  ["__New method (Buffer)","lib/BufferObj.htm#__New",7],
  ["__New method (Gui)","lib/GuiObj.htm#__New",7],
  ["__New method (Map)","lib/MapObj.htm#__New",7],
  ...
  ["Add method (Gui)","lib/GuiObj.htm#Add",7],
  ["Add method (GuiControl)","lib/GuiControlObj.htm#Add",7],
  ["Add method (ListView)","lib/ListView.htm#Add",7],
  ["Add method (Menu)","lib/MenuObj.htm#Add",7],
  ...
  ["AddStandard method (Menu)","lib/MenuObj.htm#AddStandard",7],
  ...
  ["BackColor property (Gui)","lib/GuiObj.htm#BackColor",7],
  ...
  ["Bind method (Func)","lib/FuncObj.htm#Bind",7],
  ...
  ["Call method (Array)","lib/ArrayObj.htm#Call",7],
  ["Call method (Buffer)","lib/BufferObj.htm#Call",7],
  ["Call method (Class)","lib/ClassObj.htm#Call",7],
  ["Call method (Enumerator)","lib/EnumeratorObj.htm#Call",7],
  ["Call method (Func)","lib/FuncObj.htm#Call",7],
  ["Call method (Gui)","lib/GuiObj.htm#Call",7],
  ["Call method (Map)","lib/MapObj.htm#Call",7],
  ["Call method (Menu)","lib/MenuObj.htm#Call",7],
  ...
  ["Capacity property (Array)","lib/ArrayObj.htm#Capacity",7],
  ["Capacity property (Map)","lib/MapObj.htm#Capacity",7],
  ["CaretGetPos","lib/CaretGetPos.htm",2],
  ["Case","lib/Switch.htm",3,"E"],
  ["CaseSense property (Map)","lib/MapObj.htm#CaseSense",7],
  ...
  ["Count property (Map)","lib/MapObj.htm#Count",7],
  ...
  ["Default property (Array)","lib/ArrayObj.htm#Default",7],
  ["Default property (Map)","lib/MapObj.htm#Default",7],
  ["Default property (Menu)","lib/MenuObj.htm#Default",7],
  ...
  ["Delete method (Array)","lib/ArrayObj.htm#Delete",7],
  ["Delete method (GuiControl)","lib/GuiControlObj.htm#Delete",7],
  ["Delete method (ListView)","lib/ListView.htm#Delete",7],
  ["Delete method (Map)","lib/MapObj.htm#Delete",7],
  ["Delete method (Menu)","lib/MenuObj.htm#Delete",7],
  ...
  ["Destroy method (Gui)","lib/GuiObj.htm#Destroy",7],
  ...
  ["Disable method (Menu)","lib/MenuObj.htm#Disable",7],
  ...
  ["Else","lib/Else.htm",3,""],
  ["Enable method (Menu)","lib/MenuObj.htm#Enable",7],
  ["Enabled property (GuiControl)","lib/GuiControlObj.htm#Enabled",7],
  ["Encoding property (File)","lib/FileObj.htm#Encoding",7],
  ...
  ["Enumerator","lib/EnumeratorObj.htm",6],
  ...
  ["Flash method (Gui)","lib/GuiObj.htm#Flash",7],
  ...
  ["Focus method (GuiControl)","lib/GuiControlObj.htm#Focus",7],
  ["Focused property (GuiControl)","lib/GuiControlObj.htm#Focused",7],
  ["FocusedCtrl property (Gui)","lib/GuiObj.htm#FocusedCtrl",7],
  ...
  ["Get method (Array)","lib/ArrayObj.htm#Get",7],
  ["Get method (Map)","lib/MapObj.htm#Get",7],
  ["Get method (TreeView)","lib/TreeView.htm#Get",7],
  ["GetChild method (TreeView)","lib/TreeView.htm#GetChild",7],
  ["GetClientPos method (Gui)","lib/GuiObj.htm#GetClientPos",7],
  ...
  ["GetPos method (Gui)","lib/GuiObj.htm#GetPos",7],
  ["GetPos method (GuiControl)","lib/GuiControlObj.htm#GetPos",7],
  ...
  ["Gui","lib/GuiObj.htm",6],
  ["Gui (create a GUI)","lib/GuiObj.htm#Call"],
  ["Gui control types","lib/GuiControls.htm"],
  ["Gui events","lib/GuiOnEvent.htm"],
  ["Gui property (GuiControl)","lib/GuiControlObj.htm#Gui",7],
  ["Gui styles reference","misc/Styles.htm"],
  ["GuiControl object","lib/GuiControlObj.htm"],
  ["GuiCtrlFromHwnd","lib/GuiCtrlFromHwnd.htm",2],
  ["GuiFromHwnd","lib/GuiFromHwnd.htm",2],
  ["Handle property (File)","lib/FileObj.htm#Handle",7],
  ["Handle property (Menu)","lib/MenuObj.htm#Handle",7],
  ["Has method (Array)","lib/ArrayObj.htm#Has",7],
  ["Has method (Map)","lib/MapObj.htm#Has",7],
  ...
  ["Hide method (Gui)","lib/GuiObj.htm#Hide",7],
  ...
  ["Hwnd property (Gui)","lib/GuiObj.htm#Hwnd",7],
  ["Hwnd property (GuiControl)","lib/GuiControlObj.htm#Hwnd",7],
  ...
  ["IndexError","lib/ErrorObj.htm#IndexError",6],
  ...
  ["Insert method (Menu)","lib/MenuObj.htm#Insert",7],
  ["InsertAt method (Array)","lib/ArrayObj.htm#InsertAt",7],
  ...
  ["IsBuiltIn property (Func)","lib/FuncObj.htm#IsBuiltIn",7],
  ["IsByRef method (Func)","lib/FuncObj.htm#IsByRef",7],
  ...
  ["IsOptional method (Func)","lib/FuncObj.htm#IsOptional",7],
  ...
  ["IsVariadic property (Func)","lib/FuncObj.htm#IsVariadic",7],
  ...
  ["Length property (Array)","lib/ArrayObj.htm#Length",7],
  ["Length property (File)","lib/FileObj.htm#Length",7],
  ...
  ["Line property (Error)","lib/ErrorObj.htm#Line",7],
  ...
  ["Map","lib/MapObj.htm",6],
  ["MarginX property (Gui)","lib/GuiObj.htm#MarginX",7],
  ["MarginY property (Gui)","lib/GuiObj.htm#MarginY",7],
  ...
  ["Maximize method (Gui)","lib/GuiObj.htm#Maximize",7],
  ["MaxParams property (Func)","lib/FuncObj.htm#MaxParams",7],
  ...
  ["Menu","lib/MenuObj.htm",6],
  ["MenuBar","lib/MenuObj.htm",6],
  ["MenuBar property (Gui)","lib/GuiObj.htm#MenuBar",7],
  ["MenuFromHandle","lib/MenuFromHandle.htm",2],
  ["MenuSelect","lib/MenuSelect.htm",2],
  ["MemberError","lib/ErrorObj.htm#MemberError",6],
  ["MemoryError","lib/ErrorObj.htm#MemoryError",6],
  ["message list (WM_*)","misc/SendMessageList.htm"],
  ["Message property (Error)","lib/ErrorObj.htm#Message",7],
  ...
  ["MethodError","lib/ErrorObj.htm#MemberError",6],
  ["methods (concepts)","Concepts.htm#methods"],
  ["Min","lib/Math.htm#Min",2],
  ["Minimize method (Gui)","lib/GuiObj.htm#Minimize",7],
  ["MinParams property (Func)","lib/FuncObj.htm#MinParams",7],
  ...
  ["Move method (Gui)","lib/GuiObj.htm#Move",7],
  ["Move method (GuiControl)","lib/GuiControlObj.htm#Move",7],
  ["MsgBox","lib/MsgBox.htm",2],
  ["mute (changing it)","lib/SoundSetMute.htm"],
  ["Name method/property (Match)","lib/RegExMatch.htm#MatchObject",7],
  ["Name property (Func)","lib/FuncObj.htm#Name",7],
  ["Name property (Gui)","lib/GuiObj.htm#Name",7],
  ["Name property (GuiControl)","lib/GuiControlObj.htm#Name",7],
  ...
  ["OnCommand method (GuiControl)","lib/GuiControlObj.htm#OnCommand",7],
  ["OnEnd property (InputHook)","lib/InputHook.htm#OnEnd",7],
  ["OnError","lib/OnError.htm",2],
  ["OnEvent (Gui)","lib/GuiOnEvent.htm"],
  ["OnEvent method (Gui)","lib/GuiObj.htm#OnEvent",7],
  ["OnEvent method (GuiControl)","lib/GuiControlObj.htm#OnEvent",7],
  ...
  ["OnNotify method (GuiControl)","lib/GuiControlObj.htm#OnNotify",7],
  ["open file","lib/FileOpen.htm"],
  ["operators in expressions","Variables.htm#Operators"],
  ["Opt method (Gui)","lib/GuiObj.htm#Opt",7],
  ["Opt method (GuiControl)","lib/GuiControlObj.htm#Opt",7],
  ["or","Variables.htm#or",4],
  ["Ord","lib/Ord.htm",2],
  ["OSError","lib/ErrorObj.htm#OSError",6],
  ["OutputDebug","lib/OutputDebug.htm",2],
  ["OwnDialogs (GUI)","lib/GuiObj.htm#OwnDialogs"],
  ["Owner of a GUI window","lib/GuiObj.htm#Owner"],
  ...
  ["Pop method (Array)","lib/ArrayObj.htm#Pop",7],
  ["Pos method/property (Match)","lib/RegExMatch.htm#MatchObject",7],
  ["Pos property (File)","lib/FileObj.htm#Pos",7],
  ...
  ["PropertyError","lib/ErrorObj.htm#MemberError",6],
  ["Prototype property (Class)","lib/ClassObj.htm#Prototype",7],
  ["Ptr property (Buffer)","lib/BufferObj.htm#Ptr",7],
  ["Push method (Array)","lib/ArrayObj.htm#Push",7],
  ...
  ["RawRead method (File)","lib/FileObj.htm#RawRead",7],
  ["RawWrite method (File)","lib/FileObj.htm#RawWrite",7],
  ["read file","lib/FileRead.htm"],
  ["Read method (File)","lib/FileObj.htm#Read",7],
  ["ReadLine method (File)","lib/FileObj.htm#ReadLine",7],
  ["ReadNumType method (File)","lib/FileObj.htm#ReadNum",7],
  ["READONLY","lib/FileGetAttrib.htm"],
  ["reboot","lib/Shutdown.htm"],
  ["Redraw method (GuiControl)","lib/GuiControlObj.htm#Redraw",7],
  ...
  ["RemoveAt method (Array)","lib/ArrayObj.htm#RemoveAt",7],
  ["rename file","lib/FileMove.htm"],
  ["Rename method (Menu)","lib/MenuObj.htm#Rename",7],
  ["resize a window","lib/WinMove.htm"],
  ["restart the computer","lib/Shutdown.htm"],
  ["Restore method (Gui)","lib/GuiObj.htm#Restore",7],
  ...
  ["Scripts","Scripts.htm"],
  ["Seek method (File)","lib/FileObj.htm#Seek",7],
  ...
  ["Set method (Map)","lib/MapObj.htm#Set",7],
  ["SetCapsLockState","lib/SetNumScrollCapsLockState.htm",2],
  ["SetColor method (Menu)","lib/MenuObj.htm#SetColor",7],
  ["SetControlDelay","lib/SetControlDelay.htm",2],
  ["SetDefaultMouseSpeed","lib/SetDefaultMouseSpeed.htm",2],
  ["SetFont method (Gui)","lib/GuiObj.htm#SetFont",7],
  ["SetFont method (GuiControl)","lib/GuiControlObj.htm#SetFont",7],
  ["SetFormat method (GuiControl)","lib/GuiControlObj.htm#SetFormat",7],
  ["SetIcon method (Menu)","lib/MenuObj.htm#SetIcon",7],
  ...
  ["Show method (Gui)","lib/GuiObj.htm#Show",7],
  ["Show method (Menu)","lib/MenuObj.htm#Show",7],
  ...
  ["Size property (Buffer)","lib/BufferObj.htm#Size",7],
  ...
  ["Stack property (Error)","lib/ErrorObj.htm#Stack",7],
  ...
  ["Submit method (Gui)","lib/GuiObj.htm#Submit",7],
  ...
  ["TargetError","lib/ErrorObj.htm#TargetError",6],
  ...
  ["Text property (GuiControl)","lib/GuiControlObj.htm#Text",7],
  ...
  ["TimeoutError","lib/ErrorObj.htm#TimeoutError",6],
  ...
  ["Title property (Gui)","lib/GuiObj.htm#Title",7],
  ["ToggleCheck method (Menu)","lib/MenuObj.htm#ToggleCheck",7],
  ["ToggleEnable method (Menu)","lib/MenuObj.htm#ToggleEnable",7],
  ...
  ["Type","lib/Type.htm",2],
  ["Type property (GuiControl)","lib/GuiControlObj.htm#Type",7],
  ["TypeError","lib/ErrorObj.htm#TypeError",6],
  ["Uncheck method (Menu)","lib/MenuObj.htm#Uncheck",7],
  ["Unset","Language.htm#unset",1],
  ["UnsetError","lib/ErrorObj.htm#UnsetError",6],
  ["UnsetItemError","lib/ErrorObj.htm#UnsetError",6],
  ...
  ["UseTab method (GuiControl)","lib/GuiControlObj.htm#UseTab",7],
  ["Value property (GuiControl)","lib/GuiControlObj.htm#Value",7],
  ["ValueError","lib/ErrorObj.htm#ValueError",6],
  ...
  ["Visible property (GuiControl)","lib/GuiControlObj.htm#Visible",7],
  ...
  ["What property (Error)","lib/ErrorObj.htm#What",7],
  ...
  ["Write method (File)","lib/FileObj.htm#Write",7],
  ["WriteLine method (File)","lib/FileObj.htm#WriteLine",7],
  ["WriteNumType method (File)","lib/FileObj.htm#WriteNum",7],
  ["WS_* (GUI styles)","misc/Styles.htm"],
  ["XButton","KeyList.htm#mouse-advanced"],
  ["YYYYMMDDHH24MISS","lib/FileSetTime.htm#YYYYMMDD"],
  ["ZeroDivisionError","lib/ErrorObj.htm#ZeroDivisionError",6],
