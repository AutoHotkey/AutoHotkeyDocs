index = [
  ...
  ["context menu (GUI)","commands/GuiCreate.htm#ContextMenu"],
  ...
  ["drag and drop (GUI windows)","commands/GuiCreate.htm#DropFiles"],
  ...
  ["Gui event: Close","commands/GuiCreate.htm#Close"],
  ["Gui event: ContextMenu","commands/GuiCreate.htm#ContextMenu"],
  ["Gui event: DropFiles","commands/GuiCreate.htm#DropFiles"],
  ["Gui event: Escape","commands/GuiCreate.htm#Escape"],
  ["OnExit","commands/OnExit.htm"],
  ["OnMessage()","commands/OnMessage.htm"],
  ["Gui event: Size","commands/GuiCreate.htm#Size"],
