index = [
  ...
  ["Close (Gui event)","objects/Gui.htm#Close"],
  ...
  ["ContextMenu (Gui event)","objects/Gui.htm#ContextMenu"],
  ...
  ["drag and drop (GUI windows)","objects/Gui.htm#DropFiles"],
  ...
  ["DropFiles (Gui event)","objects/Gui.htm#DropFiles"],
  ...
  ["Escape (Gui event)","objects/Gui.htm#Escape"],
  ...
  ["g-label (responding to GUI events)","objects/Gui.htm#label"],
  ...
  ["Gui events","objects/Gui.htm#OnEvent"],
  ["Gui object", "objects/Gui.htm"],
  ["Gui styles reference","misc/Styles.htm"],
  ["GuiClose event","objects/Gui.htm#Close"],
  ["GuiContextMenu event","objects/Gui.htm#ContextMenu"],
  ["GuiControl object","objects/GuiControl.htm"],
  ["GuiCreate","commands/GuiCreate.htm"],
  ["GuiCtrlFromHwnd","commands/GuiCtrlFromHwnd.htm"],
  ["GuiDropFiles event","objects/Gui.htm#DropFiles"],
  ["GuiEscape event","objects/Gui.htm#Escape"],
  ["GuiFromHwnd","commands/GuiFromHwnd.htm"],
  ["GuiSize event","objects/Gui.htm#Size"],
  ...
  ["SingleInstance","commands/_SingleInstance.htm"],
  ["Size (Gui event)","objects/Gui.htm#Size"],
