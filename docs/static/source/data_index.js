index = [
  ...
  ["context menu (GUI)","commands/GuiCreate.htm#OnContextMenu"],
  ...
  ["drag and drop (GUI windows)","commands/GuiCreate.htm#OnDropFiles"],
  ...
  ["OnClose (Gui event)","commands/GuiCreate.htm#OnClose"],
  ["OnContextMenu (Gui event)","commands/GuiCreate.htm#OnContextMenu"],
  ["OnDropFiles (Gui event)","commands/GuiCreate.htm#OnDropFiles"],
  ["OnEscape (Gui event)","commands/GuiCreate.htm#OnEscape"],
  ["OnExit","commands/OnExit.htm"],
  ["OnMessage()","commands/OnMessage.htm"],
  ["OnSize (Gui event)","commands/GuiCreate.htm#OnSize"],
  ...
  ["Label controls (GUI)","commands/GuiControls.htm#Label"],
